...
//#define LV_ASSERT_HANDLER while(1);   /*Halt by default*/
    ...
    #define LV_ASSERT_HANDLER \
        My_Assert_Handler(__FILE__, __LINE__, __func__);
#else
    #define LV_ASSERT_HANDLER
#endif
/*-------------
...
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(lv_font_founder_kaiti_simplified_24)

/*Always set a default font*/
#define LV_FONT_DEFAULT &lv_font_founder_kaiti_simplified_24
